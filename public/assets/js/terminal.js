class GitTerminal {
    ...
    scrollToBottom() {
        ...
        // Also ensure the new content is visible by using scrollIntoView
        const lastLine = this.terminalOutput.lastElementChild;
        if (lastLine) {
            lastLine.scrollIntoView({ block: 'start', inline: 'nearest' });
        }
    }
    ...
    showLessonCompletion() {
        ...
        // Previous Scenario button (if exists)
        ...
        // Next Scenario button (if exists)
